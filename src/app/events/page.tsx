...
const upcomingEvents = [
  ...
  },
  {
    ...
    description: 'Mid-week Bible study and prayer meeting. All are welcome to join us as we study God\'s Word together.',
    image: 'https://images.unsplash.com/photo-1588072432836-e100327743db?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80',
  ...
  },
  {
    ...
    description: 'A fun and engaging time for youth to grow in their faith. Games, worship, and relevant Bible teaching.',
  ...
  },
  {
    ...
    location: 'Fellowship Hall',
    description: 'A time for men to connect over a good breakfast and encouraging conversation.',
  ...
  },
  {
    ...
    location: 'Fellowship Hall',
    description: 'A time for women to come together for fellowship, prayer, and encouragement.',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1507676184212-d03ab07a01a1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80',
    category: 'Outreach'
  }
];
...
const categories = [
  ...
  { name: 'Worship', count: upcomingEvents.filter(event => event.category === 'Worship').length },
  { name: 'Bible Study', count: upcomingEvents.filter(event => event.category === 'Bible Study').length },
  { name: 'Youth', count: upcomingEvents.filter(event => event.category === 'Youth').length },
  { name: 'Men', count: upcomingEvents.filter(event => event.category === 'Men').length },
  { name: 'Women', count: upcomingEvents.filter(event => event.category === 'Women').length },
  { name: 'Outreach', count: upcomingEvents.filter(event => event.category === 'Outreach').length },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-12">
            {categories.map((category) => (
              <button
                key={category.name}
                className={`px-4 py-2 rounded-full text-sm font-medium ${category.name === 'All' ? 'bg-indigo-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-100'} shadow-sm`}
              >
          ...
          {upcomingEvents.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="mt-2 text-gray-600">Check back later for upcoming events and activities.</p>
            </div>
          )}
